...
model_names += ['efficientnet-b0', 'efficientnet-b1', 'mobilenetv3-large']
...
parser.add_argument('--teacher', type=str, default='moco_v2_200ep_pretrain.pth.tar',
                    help='path to pretrained teacher (which was trained by MoCo v2)')
...
def main():
    ...
    args.model_name = 'ImageNet_{}_lr_{}_bsz{}_pred_h_dim_{}'.format(
        args.arch, args.lr, args.batch_size, args.pred_h_dim
    )
